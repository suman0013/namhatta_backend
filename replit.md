...
## Changelog
- June 30, 2025: Fixed inconsistent heights in devotee detail Status Management cards by setting fixed height of 384px (h-96) with scrollable content areas for uniform sizing across screen sizes
